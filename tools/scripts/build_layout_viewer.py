...
def main() -> None:
    ...
    parts.append("<p>This page shows the rendered PNG previews for the physical layout generated by the ASIC flow.</p>")

    if gds_rel:
        parts.append(f'<p><a href="{gds_rel}">Download GDS</a> for local inspection in KLayout.</p>')
    else:
        parts.append("<p>No GDS file was copied into this artifact.</p>")

    if not renders:
        parts.append("<p>No PNG renders were generated.</p>")
    else:
    ...
    parts.append("<ul>")
    parts.append("<li>The previews are static PNG snapshots generated from the GDS.</li>")
    parts.append("<li>For real layer inspection or 3D-style stack viewing, open the GDS locally in KLayout.</li>")
    parts.append("</ul>")
    parts.append("</body>")
    parts.append("</html>")
